...
public class fishingRoadMark : MonoBehaviour
{
    // 钓鱼湖路标指引提示
    // 判断是否碰撞到路标
    ...
    public void FishingRoadMark() {
        ...
        if (Input.GetKeyDown(KeyCode.E)) {
            ...
            // 变更文本
            string[] textContent = { "前往西北方到钓鱼湖" };

            dialogGameObject.transform.GetChild(0).GetComponent<DialogPrefab>().message = textContent;
            //dialogGameObject.transform.GetChild(0).GetChild(0).GetChild(0).GetComponent<Text>().text = "前往左上方到钓鱼湖";
        }
    }
