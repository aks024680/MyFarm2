...
public class touchHome : MonoBehaviour
{
    ...
    public void triggerDialog()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            // 变更文本
            string[] textContent = { "暂无素材，停止开发此地!" };

            dialogGameObject.transform.GetChild(0).GetComponent<DialogPrefab>().message = textContent;
            //dialogGameObject.transform.GetChild(0).GetChild(0).GetChild(0).GetComponent<Text>().text = "暂无素材，停止开发此地!";
        }
    }
